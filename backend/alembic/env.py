...
def include_object(object_, name, type_, reflected, compare_to):
    """Allow generation of the pre-v1.7 baseline independently of new tables."""
    baseline = context.get_x_argument(as_dictionary=True).get("baseline") == "true"
    return not (baseline and type_ == "table" and name in _AGENT_OPERATIONS_TABLES)
